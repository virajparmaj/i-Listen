  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <span style={{ position: "absolute", top: 11, fontFamily: "var(--font-typewriter)", fontSize: 8, fontWeight: "var(--weight-regular)", letterSpacing: "var(--tracking-label)", color: "var(--text-chrome-muted)", textTransform: "uppercase" }}>Menu</span>
        <span style={{ position: "absolute", bottom: 12, fontSize: 9, color: "var(--text-chrome-muted)" }}>&#9654;&#9646;&#9646;</span>
        <span style={{ position: "absolute", left: 12, fontSize: 9, color: "var(--text-chrome-muted)" }}>&#9664;&#9664;</span>
        <span style={{ position: "absolute", right: 11, fontSize: 9, color: "var(--text-chrome-muted)" }}>&#9654;&#9654;</span>
